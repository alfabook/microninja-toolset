...
from microninja.gtk3 import cursor
from microninja.gtk3.apply_styles import apply_styling_to_widget, apply_colours_to_widget
...
class KanoButton(GenericButton):
    BUTTON_CSS = os.path.join(common_css_dir, 'microninja_button.css')
    ...
    def __init__(self, text="", color="green", icon_filename=""):
        ...
        style_context.add_class("microninja_button")
        style_context.add_class("microninja_button_padding")

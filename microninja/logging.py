...
'''
This module provides the core microninja logging functionality
'''
...
from microninja.utils import get_home_by_username

LOG_ENV = "LOG_LEVEL"
OUTPUT_ENV = "OUTPUT_LEVEL"
FORCE_FLUSH_ENV = "KLOG_FORCE_FLUSH"
SYSTEM_LOGS_DIR = "/var/log/microninja/"
...
USER_LOGS_DIR = os.path.join(home_folder, '.microninja-logs')

CONF_FILE = "/etc/microninja-logs.conf"

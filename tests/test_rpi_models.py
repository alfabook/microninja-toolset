...
import microninja.utils
from microninja.utils import get_rpi_model as getrpi
...
class TestModelAsserters(unittest.TestCase):
    ...
    def test_models_asserts(self):
        self.assertTrue (microninja.utils.is_model_a('0007'))
        self.assertTrue (microninja.utils.is_model_b('0004'))
        self.assertTrue (microninja.utils.is_model_b_plus('0010'))
        self.assertTrue (microninja.utils.is_model_2_b('0xA01041'))
